  ...
  return (
    <div className="space-y-5" dir="rtl">
      <Hero
        eyebrow="الدوام"
        title="شركاء الدوام"
        subtitle="المجموعات تتكوّن تلقائياً من الشراكة المتبادَلة (شركاء الوردية بملفك الشخصي)"
      />
      ...
      {loading ? (
        ...
        <Card>
          <p className="text-center py-8 text-muted text-sm">
            لا توجد مجموعات بعد — تتكوّن المجموعة تلقائياً عندما يتفق موظفان أو ثلاثة
            كشركاء وردية (اطلب/اقبل من ملفك الشخصي ← «شركاء الوردية»).
          </p>
        </Card>
      ) : (
      ...
      {/* شريك محدَّد لكن الطرف الآخر غير نشط أو غير موجود بالنظام */}
      {!loading && pending.length > 0 && (
        <Card>
          <CardTitle>بانتظار اكتمال البيانات ({pending.length})</CardTitle>
          <p className="text-[11px] text-muted mt-1">
            لكلٍّ منهم شراكة محدَّدة، لكن الشريك المذكور إمّا غير نشط حالياً بالنظام أو
            اسمه غير مطابق لأي موظف — راجع «المستخدمون» للتحقق من حالة حسابه.
          </p>
