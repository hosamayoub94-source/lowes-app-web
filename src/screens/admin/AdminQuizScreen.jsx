...
const QUESTION_TEMPLATES = [
  // Products
  { category: 'products', question: 'ما هو نوع منتج الكريم المرطب الأساسي من لويز؟', option_a: 'كريم مرطب للبشرة الجافة', option_b: 'كريم للتبييض فقط', option_c: 'واقي شمس', option_d: 'منتج للتقشير', correct_answer: 'a', explanation: 'كريم المرطب الأساسي مصمم للبشرة الجافة ويوفر ترطيبًا عميقًا.' },
  { category: 'products', question: 'كم عدد المنتجات الرئيسية في خط العناية بالبشرة من لويز؟', option_a: '5 منتجات', option_b: '10 منتجات أو أكثر', option_c: '3 منتجات فقط', option_d: '2 منتج', correct_answer: 'b', explanation: 'يضم خط العناية بالبشرة من لويز أكثر من 10 منتجات متخصصة.' },
  ...
  // Company
  { category: 'company', question: 'ما هي الأسواق الرئيسية التي تعمل فيها لويز بروفشنال؟', option_a: 'تركيا والإمارات والشرق الأوسط وسوريا', option_b: 'أمريكا وأوروبا فقط', option_c: 'المملكة العربية السعودية فقط', option_d: 'دول آسيا حصرًا', correct_answer: 'a', explanation: 'لويز بروفشنال براند عناية بالبشرة والكوزمتك يخدم أسواق تركيا والإمارات والشرق الأوسط وسوريا.' },
  { category: 'company', question: 'ما هي رسالة شركة لويز بروفشنال؟', option_a: 'تقديم منتجات عناية بالبشرة عالية الجودة بأسعار مناسبة', option_b: 'الترفيه والموضة فقط', option_c: 'المنتجات الغذائية', option_d: 'الإلكترونيات', correct_answer: 'a', explanation: 'لويز تؤمن بأن كل شخص يستحق عناية فعّالة بالبشرة.' },
  ...
  { category: 'company', question: 'ما هي قيمة الشركة الأساسية تجاه منتجاتها؟', option_a: 'الجودة والفعالية المثبتة علميًا', option_b: 'الربح أولاً', option_c: 'الكمية على حساب الجودة', option_d: 'التصدير فقط', correct_answer: 'a', explanation: 'لويز تلتزم بتقديم منتجات مبنية على أبحاث علمية وتركيبات محسوبة.' },
  ...
  // ── منتجات لويز — أسئلة حقيقية ──────────────────────────────

  // Products — معلومات المنتجات
  { category: 'products', question: 'ما حجم غسول الوجه اليومي من لويز (Facial Cleanser Gel)؟', option_a: '250ml', option_b: '100ml', option_c: '50ml', option_d: '500ml', correct_answer: 'a', explanation: 'غسول الوجه اليومي يأتي بحجم 250ml — اقتصادي للاستخدام اليومي صباحاً ومساءً.' },
  { category: 'products', question: 'ما نسبة الريتينول في سيروم الريتينول من لويز؟', option_a: '1%', option_b: '0.5%', option_c: '2%', option_d: '0.1%', correct_answer: 'a', explanation: 'سيروم الريتينول من لويز يحتوي على نسبة عالية 1% مناسبة لمكافحة علامات الشيخوخة.' },
  { category: 'products', question: 'أي منتج من لويز مخصص للبشرة الدهنية والمختلطة تحديداً؟', option_a: 'غسول البشرة الدهنية (Oily Skin Facial Cleanser)', option_b: 'غسول الوجه العادي', option_c: 'كريم المرطب', option_d: 'ماسك الكولاجين', correct_answer: 'a', explanation: 'لويز لديها غسول مخصص للبشرة الدهنية يزيل الزهم الزائد ويفتح المسام المسدودة.' },
  { category: 'products', question: 'ما أصغر منتج من لويز من حيث الحجم؟', option_a: 'سيروم الهالات تحت العين (15ml)', option_b: 'سيروم الريتينول (30ml)', option_c: 'واقي الشمس (75ml)', option_d: 'ماء الروزماري (100ml)', correct_answer: 'a', explanation: 'سيروم الهالات تحت العين يأتي بحجم 15ml لأن المنطقة حساسة وتحتاج كميات صغيرة جداً.' },
  { category: 'products', question: 'ما الفرق الرئيسي بين واقي الشمس الزهري والبرتقالي من لويز؟', option_a: 'الزهري يعطي توهجاً ورديّاً، البرتقالي يمنح لوناً برونزياً طبيعياً', option_b: 'لا فرق بينهما', option_c: 'الزهري للنساء والبرتقالي للرجال', option_d: 'الزهري SPF30 والبرتقالي SPF50', correct_answer: 'a', explanation: 'كلاهما SPF50+ لكن يختلفان في التأثير اللوني — الزهري لمن يريد توهجاً مشرقاً، البرتقالي لمن يفضل اللون البرونزي الصيفي.' },
  { category: 'products', question: 'أي منتج من لويز مخصص للرجال تحديداً؟', option_a: 'سيروم الدقن (Beard Serum)', option_b: 'كريم المرطب', option_c: 'سيروم الكولاجين', option_d: 'جل مقشّر', correct_answer: 'a', explanation: 'سيروم الدقن هو المنتج الوحيد المخصص للرجال في مجموعة لويز — يقوّي اللحية ويزيد كثافتها.' },
  { category: 'products', question: 'ما الفرق بين سيروم الريتينول وكريم الريتينال شوت (Retinal Shot) من لويز؟', option_a: 'الريتينال أقوى وأسرع تأثيراً من الريتينول العادي', option_b: 'الريتينول أقوى', option_c: 'هما نفس المنتج بأسماء مختلفة', option_d: 'الريتينال للترطيب فقط', correct_answer: 'a', explanation: 'الريتينال (Retinaldehyde) شكل أقرب للريتينوييك أسيد النشط في الجسم — أسرع تأثيراً بمرات من الريتينول.' },
  { category: 'products', question: 'ما منتج لويز الوحيد 100% طبيعي بمكوّن واحد فقط؟', option_a: 'تونر الشعر — ماء الروزماري النقي (Pure Rosemary Water)', option_b: 'شامبو الروزماري', option_c: 'زيت المساج', option_d: 'سيروم الكولاجين', correct_answer: 'a', explanation: 'ماء الروزماري النقي مكوّن واحد فقط: Rosmarinus Officinalis Leaf Water — هيدروسول طبيعي 100%.' },
  { category: 'products', question: 'كم يبلغ وزن سكراب الجسم بالفراولة من لويز؟', option_a: '275g', option_b: '100g', option_c: '500g', option_d: '150g', correct_answer: 'a', explanation: 'سكراب الجسم بالفراولة يأتي بوزن 275g — كمية وفيرة مناسبة للاستخدام الأسبوعي.' },
  ...
  { category: 'products', question: 'ما أفضل استخدام لزيت روزماري الشعر (Rosemary Hair Oil) من لويز؟', option_a: 'يصلح للشعر وفروة الرأس والرموش والحواجب معاً', option_b: 'للشعر فقط', option_c: 'للوجه فقط', option_d: 'كواقي شمس للشعر', correct_answer: 'a', explanation: 'زيت الروزماري من لويز يحتوي على 20+ زيت طبيعي ويصلح للشعر والرموش والحواجب.' },
  { category: 'products', question: 'ما الفرق بين سيروم الصدر وكريم الصدر من لويز؟', option_a: 'السيروم للشد والرفع، الكريم للترطيب والتغذية — يستخدمان معاً', option_b: 'هما نفس المنتج', option_c: 'الكريم أقوى من السيروم', option_d: 'السيروم للنهار فقط', correct_answer: 'a', explanation: 'لويز تقدم عناية متكاملة للصدر: السيروم يشد ويرفع، والكريم يغذّي ويرطب — الاثنان معاً أفضل نتائج.' },
  { category: 'products', question: 'كم من الوقت يستغرق كريم إزالة الشعر من لويز؟', option_a: '7-9 دقائق', option_b: '20-30 دقيقة', option_c: 'دقيقتين فقط', option_d: 'ساعة كاملة', correct_answer: 'a', explanation: 'كريم إزالة الشعر من لويز يعمل خلال 7-9 دقائق فقط — لا تتركه أكثر من 9 دقائق.' },

  // Ingredients — مكونات المنتجات
  { category: 'ingredients', question: 'ما نسبة Alpha-Arbutin في سيروم البقع الداكنة من لويز؟', option_a: '2%', option_b: '0.5%', option_c: '5%', option_d: '1%', correct_answer: 'a', explanation: 'سيروم البقع من لويز يحتوي على Alpha-Arbutin بنسبة 2% — نسبة عالية الفعالية لتفتيح البقع.' },
  { category: 'ingredients', question: 'ما المكونات الخمسة الرئيسية في كريم التبييض من لويز؟', option_a: 'نياسيناميد، Kojic Acid، Alpha-Arbutin، Glutathione، Tranexamic Acid', option_b: 'ريتينول، كولاجين، شيا، عسل، ورد', option_c: 'حمض الهيالورونيك، بانثينول، خيار، صبار، سنتيلا', option_d: 'فيتامين C، E، B3، B5، A', correct_answer: 'a', explanation: 'كريم التبييض من لويز يجمع 5 مكونات تفتيح فعّالة في منتج واحد لنتائج أسرع.' },
  { category: 'ingredients', question: 'ما مكونات شامبو الروزماري من لويز بخلاف الروزماري؟', option_a: 'كيراتين، كولاجين، بيوتين', option_b: 'زيت الأرجان فقط', option_c: 'حمض الهيالورونيك', option_d: 'ريتينول', correct_answer: 'a', explanation: 'شامبو الروزماري من لويز يجمع إكليل الجبل مع الكيراتين والكولاجين والبيوتين لتغذية متكاملة للشعر.' },
  { category: 'ingredients', question: 'ما الحمض الكيميائي في كريم إزالة الشعر من لويز الذي يذيب الشعر؟', option_a: 'Calcium Thioglycolate', option_b: 'حمض الجليكوليك', option_c: 'حمض الهيالورونيك', option_d: 'حمض اللاكتيك', correct_answer: 'a', explanation: 'Calcium Thioglycolate يكسر روابط الكيراتين في الشعر مما يجعله يتفتت ويُزال بسهولة.' },
  { category: 'ingredients', question: 'ما الفائدة الإضافية للكافيين في جل شد الجسم من لويز؟', option_a: 'يحفّز الدورة الدموية ويساعد على تفتيت الدهون لتقليل السيلوليت', option_b: 'ترطيب فقط', option_c: 'حماية من الشمس', option_d: 'تفتيح البشرة', correct_answer: 'a', explanation: 'الكافيين في جل الجسم يحفّز الدورة الدموية الموضعية مما يساعد على تقليل مظهر السيلوليت.' },
  { category: 'ingredients', question: 'لماذا يحتوي تونر الوجه من لويز على ثلاثة أحماض مختلفة؟', option_a: 'Glycolic Acid للتقشير، Salicylic Acid لتنظيف المسام، Niacinamide لتوحيد اللون', option_b: 'لزيادة الحموضة فقط', option_c: 'لأن أحمض أكثر = أقوى دائماً', option_d: 'هي نفس الحمض بأسماء مختلفة', correct_answer: 'a', explanation: 'التونر يجمع ثلاثة أحماض لفوائد مختلفة: تقشير + تنظيف مسام + توحيد لون في منتج واحد.' },
  { category: 'ingredients', question: 'ما الفرق بين Glutathione و Alpha-Arbutin في تفتيح البشرة؟', option_a: 'كلاهما يفتّح لكن Glutathione مضاد أكسدة وArbutin يثبط إنزيم الميلانين', option_b: 'Glutathione أسرع دائماً', option_c: 'Alpha-Arbutin يفتّح فقط ليلاً', option_d: 'هما نفس المادة', correct_answer: 'a', explanation: 'يعملان بآليات مختلفة ولهذا يجمعهما لويز في الكريم للحصول على أفضل نتيجة تفتيح.' },
  ...
  { category: 'ingredients', question: 'ما المكوّن الرئيسي في سيروم الكولاجين من لويز ولماذا؟', option_a: 'كولاجين متحلل (Hydrolyzed Collagen) لأن جزيئاته أصغر وتتغلغل بشكل أفضل', option_b: 'كولاجين كامل بدون معالجة', option_c: 'كولاجين صناعي اصطناعي', option_d: 'كولاجين حيواني خام', correct_answer: 'a', explanation: 'التحليل المائي يكسر جزيئات الكولاجين لتصبح صغيرة كافية لاختراق طبقات البشرة.' },

  // Skincare — طريقة الاستخدام والتحذيرات
  { category: 'skincare', question: 'لماذا يجب استخدام سيروم الريتينول من لويز مساءً فقط؟', option_a: 'لأن الريتينول يجعل البشرة حساسة للشمس ويتحلل بالضوء', option_b: 'لأنه يسبب النعاس', option_c: 'لأن تأثيره يظهر ليلاً فقط', option_d: 'لا يهم الوقت', correct_answer: 'a', explanation: 'الريتينول يزيد حساسية البشرة للأشعة فوق البنفسجية ويتدهور بالتعرض للضوء — لهذا الليل ضروري.' },
  { category: 'skincare', question: 'كم مرة في الأسبوع يُستخدم تونر الوجه من لويز؟', option_a: '2-3 مرات أسبوعياً فقط', option_b: 'يومياً صباحاً ومساءً', option_c: 'مرة كل أسبوعين', option_d: 'يومياً مساءً فقط', correct_answer: 'a', explanation: 'التونر يحتوي على أحماض (Glycolic + Salicylic) — الإفراط يضر بالحاجز الجلدي.' },
  { category: 'skincare', question: 'ما الخطوة الإضافية الضرورية عند استخدام سيروم البقع من لويز صباحاً؟', option_a: 'وضع واقي الشمس بعده لحماية البشرة', option_b: 'لا شيء إضافي', option_c: 'وضع ماسك كولاجين فوقه', option_d: 'تنظيف الوجه مرة أخرى', correct_answer: 'a', explanation: 'سيروم البقع يحتوي على مكونات تفتيح قد تزيد حساسية البشرة للشمس — واقي الشمس ضروري.' },
  { category: 'skincare', question: 'ما الطريقة الصحيحة لوضع سيروم الهالات تحت العين من لويز؟', option_a: 'كمية صغيرة جداً بدون فرك — فقط تدليك خفيف بأطراف الأصابع', option_b: 'وضعه ودلكه بقوة للامتصاص السريع', option_c: 'بكمية كبيرة كالكريم العادي', option_d: 'وضعه ثم مسحه بعد 5 دقائق', correct_answer: 'a', explanation: 'منطقة العين رقيقة جداً — الفرك القوي يسبب تجاعيد مبكرة وتكسّر الشعيرات الدموية.' },
  { category: 'skincare', question: 'كم من الوقت يجب ترك ماسك الكولاجين من لويز؟', option_a: '15-20 دقيقة ثم الشطف', option_b: '5 دقائق فقط', option_c: 'طوال الليل', option_d: 'ساعة كاملة', correct_answer: 'a', explanation: 'ماسك الكولاجين يحتاج 15-20 دقيقة ليتغلغل في البشرة ثم يُشطف للحصول على التوهج الفوري.' },
  { category: 'skincare', question: 'كيف يُستخدم ماء الروزماري النقي من لويز؟', option_a: 'يُرشّ على الشعر وفروة الرأس ويُترك بدون شطف', option_b: 'يُضاف للشامبو', option_c: 'يُستخدم قبل الاستحمام فقط', option_d: 'يُشطف فوراً', correct_answer: 'a', explanation: 'ماء الروزماري النقي لا يحتاج شطفاً — يُرشّ ويُترك ليبقى على الشعر طوال اليوم.' },
  { category: 'skincare', question: 'عند استخدام كريم الريتينال شوت من لويز لأول مرة، كيف تبدأ؟', option_a: 'ابدأ بمرة واحدة أسبوعياً ثم زد تدريجياً', option_b: 'استخدمه يومياً من البداية', option_c: 'ضعه مرتين يومياً', option_d: 'ابدأ بكمية كبيرة لنتيجة أسرع', correct_answer: 'a', explanation: 'الريتينال أقوى من الريتينول — البشرة تحتاج وقتاً للتكيف لتجنب الاحمرار والتقشير.' },
  { category: 'skincare', question: 'ما التحذير الأهم عند استخدام كريم إزالة الشعر من لويز؟', option_a: 'لا يُستخدم على الوجه والمناطق الحساسة والجلد المجروح', option_b: 'يُستخدم فقط في الصباح', option_c: 'يُشطف بعد 30 دقيقة', option_d: 'يُستخدم قبل الحمام مباشرة', correct_answer: 'a', explanation: 'كريم إزالة الشعر يحتوي على مواد كيميائية قوية — استخدامه على الوجه أو المناطق الحساسة خطر.' },
  { category: 'skincare', question: 'لمن يُنصح بعدم استخدام منتجات الريتينول والريتينال من لويز؟', option_a: 'الحوامل والنساء اللواتي يخططن للحمل', option_b: 'من عمرهم فوق 50', option_c: 'أصحاب البشرة الجافة', option_d: 'من يستخدمون واقي الشمس', correct_answer: 'a', explanation: 'الريتينول والريتينال من مشتقات فيتامين أ — تشكل خطراً على الجنين وتُمنع تماماً أثناء الحمل.' },

  // Customer Q&A — لويز specific
  { category: 'customer_qa', question: 'عميل يريد تقليل التجاعيد، أي سيروم من لويز توصي به؟', option_a: 'سيروم الريتينول 1% أو كريم الريتينال شوت للحالات الأكثر تقدماً', option_b: 'سيروم الترطيب فقط', option_c: 'سيروم الحبوب', option_d: 'سيروم البقع', correct_answer: 'a', explanation: 'الريتينول هو الأكثر أبحاثاً لمكافحة التجاعيد — الريتينال للحالات المتقدمة التي تريد نتائج أسرع.' },
  { category: 'customer_qa', question: 'عميل يعاني من البقع الداكنة والتصبغات، ما مجموعة المنتجات المناسبة من لويز؟', option_a: 'سيروم البقع (Alpha-Arbutin 2%) + كريم بكج الرز + واقي الشمس SPF50+', option_b: 'كريم المرطب فقط', option_c: 'ماسك الكولاجين يومياً', option_d: 'غسول الوجه العادي فقط', correct_answer: 'a', explanation: 'المزيج المثالي: سيروم البقع يعالج، كريم الرز يفتّح ويرطب، وواقي الشمس يمنع عودة البقع.' },
  { category: 'customer_qa', question: 'عميل شاب يعاني من الحبوب والبشرة الدهنية، ما روتين لويز المناسب؟', option_a: 'غسول البشرة الدهنية + سيروم الحبوب (Salicylic + Niacinamide) + واقي شمس خفيف', option_b: 'كريم المرطب الثقيل فقط', option_c: 'سيروم الريتينول من البداية', option_d: 'تونر الوجه يومياً', correct_answer: 'a', explanation: 'البشرة الدهنية تحتاج تنظيفاً متخصصاً + علاج الحبوب + حماية من الشمس دون إضافة دهون.' },
  { category: 'customer_qa', question: 'رجل يريد العناية بلحيته، ما منتج لويز المناسب؟', option_a: 'سيروم الدقن (Beard Serum) — يضعه على جذور اللحية ويتركه 30-60 دقيقة', option_b: 'سيروم الريتينول', option_c: 'كريم المرطب العادي', option_d: 'زيت روزماري الشعر فقط', correct_answer: 'a', explanation: 'سيروم الدقن صُمم خصيصاً للحية — يحتوي على جوجوبا وكافيين لتقوية وزيادة كثافة اللحية.' },
  { category: 'customer_qa', question: 'عميلة تريد شد جسمها بعد الولادة، ما المنتجات المناسبة من لويز؟', option_a: 'جل شد الجسم (كافيين + عنب) + سيروم الصدر + كريم الصدر', option_b: 'كريم التبييض فقط', option_c: 'سيروم الريتينول على الجسم', option_d: 'سكراب الفراولة يومياً', correct_answer: 'a', explanation: 'مجموعة الشد من لويز تعمل على الجسم كاملاً مع عناية متخصصة لمنطقة الصدر.' },
...
function formatDateAr(iso) {
  try { return new Date(iso).toLocaleDateString('ar-SA-u-nu-latn-ca-gregory', { year: 'numeric', month: 'short', day: 'numeric' }); }
  catch { return iso; }
}
