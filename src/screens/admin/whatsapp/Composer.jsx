...
export function Composer({
  ...
  return (
    <div className="flex gap-2 items-center">
      ...
      {/* شريط أزرار ثانوية (ردود جاهزة/صورة/ملف) — قابل للتمرير أفقياً على
          الموبايل الضيق جداً بس. زرّي التسجيل/الإلغاء طلعوا من هالشريط
          وصاروا ثابتين دايماً ظاهرين (8 أغسطس 2026: كانوا داخل الشريط
          فمحصورين بعرض 45%، فما كانوا يظهروا إلا بالسحب — بَق واجهة). */}
      <div className="flex gap-2 overflow-x-auto sm:overflow-visible no-scrollbar shrink-0 max-w-[30%] sm:max-w-none">
