...
export const ROLE_STEPS = {
  default:       [ONBOARDING_STEPS.WELCOME, ONBOARDING_STEPS.ROLE_GUIDE, ONBOARDING_STEPS.DAILY_FLOW, ONBOARDING_STEPS.WALKTHROUGH],
  admin:         [ONBOARDING_STEPS.WELCOME, ONBOARDING_STEPS.ROLE_GUIDE, ONBOARDING_STEPS.DAILY_FLOW, ONBOARDING_STEPS.WALKTHROUGH],
  manager:       [ONBOARDING_STEPS.WELCOME, ONBOARDING_STEPS.ROLE_GUIDE, ONBOARDING_STEPS.DAILY_FLOW, ONBOARDING_STEPS.WALKTHROUGH],
  sales_manager: [ONBOARDING_STEPS.WELCOME, ONBOARDING_STEPS.ROLE_GUIDE, ONBOARDING_STEPS.DAILY_FLOW, ONBOARDING_STEPS.WALKTHROUGH],
};
