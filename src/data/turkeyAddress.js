// =============================================================
// Official Turkish administrative divisions — all 81 provinces (İl)
// and their districts (İlçe). Used for cascading address dropdowns:
//   İl → İlçe → (Mahalle / Sokak / No / Daire typed) → full address.
// =============================================================

export const TR_PROVINCES_DISTRICTS = {
...
export const TR_PROVINCES = Object.keys(TR_PROVINCES_DISTRICTS).sort((a, b) => a.localeCompare(b, 'tr'));
