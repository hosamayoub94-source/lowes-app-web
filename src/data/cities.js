...
// سوريا — أسماء رسمية موحَّدة (D-0xx، تدقيق 24 آب 2026): كانت هذه القائمة تحوي
// صيغاً غير موحَّدة («شركة الكرم»، «إيزلا» بالهمزة، «توصيل ميتور») تسبَّبت بتشتت
// نفس الشركة تحت أكثر من اسم بالطلبات الفعلية. الأسماء أدناه = القائمة الرسمية
// المعتمدة التي يُقفَل عليها اختيار الموظف الآن (راجع @services/shippingService
// لمنطق القائمة الحيّة/الترتيب عند الطباعة). الطلبات القديمة بالصيغ السابقة تبقى
// كما هي — تُطابَق مرونةً وقت الطباعة فقط، بلا أي تعديل على بياناتها المحفوظة.
export const SYRIA_SHIPPING  = ['قدموس', 'الكرم', 'بابل', 'الموتور', 'ايزلا', 'توصيل جرمانا', 'مسارات', 'أخرى'];
