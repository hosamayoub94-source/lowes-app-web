...
- **⏳ لم يُنفَّذ بعد (نطاقه أكبر):** ربط الموقع (`lowesprofesyonel.com`) كمصدر معرفة حي بدل الكتالوج الثابت بالكود — بنية الموقع غير معروفة بعد، يحتاج جلسة منفصلة للتحقّق.
