...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    // بالكامل هنا — قرار مالك 11 يونيو: «الحالة مملوكة للجدول/الفريق». قرار مالك
    // 29 يوليو 2026 يُلغيه: التطبيق والجدول الآن مصدر واحد متزامن لأي تغيير حالة
    // (يدوي أو من شركة الشحن). الحارس ضد التكرار (طلب مُسلَّم انتقل يدوياً لتاب
    // «Delivered Orders») صار داخل doPost نفسه (lowes-sales-sync.gs) بدل هنا.
