...
**المتبقّي في #5:** المرحلة 2 سندات قبض/صرف رسمية (طوّر `paymentVoucher.js`) · المرحلة 3 تقارير + ربط بالطلبات/العمولات. التفاصيل في memory `accounting_v5_plan`.

> المتبقي: #5 مرحلتان 2و3 · #3 دليل per-role · #6 تطوير لوزي.
