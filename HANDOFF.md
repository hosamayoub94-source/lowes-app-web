...
2. re-sync فعلي للطلبات غير المنتهية الموسومة «synced» كذباً (`last_synced_at IS NULL`: 146 سوريا + 34 تركيا حيّ).
3. شوائب بيانات فردية: `6SA-517`/`6SA-519` (بالجدول فقط، انكتبوا يدوياً) · `6SA-2` (بالتطبيق فقط) · `5SA-362` (بتابي LOWES Sales+Delivered) · 5 تأخّرات حالة بتركيا (6S536/546/558، 6L78، 6S514).
